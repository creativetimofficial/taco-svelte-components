...
export const menuClass =
  "bg-white border border-blue-gray-50 rounded-md shadow-lg shadow-blue-gray-500/10 text-blue-gray-500 font-sans text-sm font-normal max-h-96 focus:outline-none overflow-auto p-3 w-full absolute z-[99] top-12";
